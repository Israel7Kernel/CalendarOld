...
var selectBoxHighlightColor = '#d6d608'; // COLOR DE FECHA SELECCIONADA
...
function highlightSelect()
{
	...
	if(this.className=='selectBox'){
		...
		this.getElementsByTagName('IMG')[0].src = pathToImg + 'down_over.png';
	}else if(this.className=='selectBoxOver'){
		this.className = 'selectBox';
		this.getElementsByTagName('IMG')[0].src = pathToImg + 'down.png';
	}
...
function highlightArrow()
{
	if(this.src.indexOf('over')>=0){
		if(this.src.indexOf('left')>=0)this.src = pathToImg + 'left.png';
		if(this.src.indexOf('right')>=0)this.src = pathToImg + 'right.png';
	}else{
		if(this.src.indexOf('left')>=0)this.src = pathToImg + 'left_over.png';
		if(this.src.indexOf('right')>=0)this.src = pathToImg + 'right_over.png';
	}
}
...
{
	if(this.src.indexOf('over')>=0){
		this.src = pathToImg + 'close.png';
	}else{
		this.src = pathToImg + 'close_over.png';
	}
...
function writeTimeBar()
{
	...
	var img = document.createElement('IMG');
	img.src = pathToImg + 'down_time.png';
